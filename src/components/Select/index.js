...
const Select = ({
  ...
  const changeValue = (newValue) => {
    onChange(newValue); // ✅ On passe la nouvelle valeur à la fonction du composant parent
    setValue(newValue);  // ✅ On met à jour la valeur affichée dans le Select
    setCollapsed(true);  // ✅ On force le menu à se refermer proprement (true = replié)
  };
  return (
